  ...
  <div class="demo-controls-groups">
    ...
    <fieldset class="demo-controls">
      ...
      <label>
        <input
          ...
          data-testid="toggle-show-resize-handles"
          type="checkbox" />
        showResizeHandles
      </label>
    </fieldset>
    ...
    <fieldset class="demo-controls">
      ...
      <label>
        <input
          ...
          data-testid="toggle-spanish-labels"
          type="checkbox" />
        ariaLabels (Spanish)
      </label>
      <label>
    ...
    <fieldset class="demo-controls">
      ...
      <button
        ...
        type="button"
        @click="savePreset('compact')">
        Save preset "compact"
      </button>
      <button
        data-testid="save-preset-detailed"
        type="button"
        @click="savePreset('detailed')">
        Save preset "detailed"
      </button>
      <button
    ...
    <GridLayout
      ...
      <GridItem
        ...
        <template #resize-handle>
          <span
            class="demo-resize-icon"
            data-testid="custom-resize-handle">⤡</span>
        </template>
      </GridItem>
    </GridLayout>
  </div>
