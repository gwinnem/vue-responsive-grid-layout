<template>
  ...
  <div class="demo-controls">
    ...
    <label>
      ...
      <input v-model.number="containerWidth" data-testid="input-container-width" max="2000" min="200" step="10" type="range" />
      {{ containerWidth }}px
    </label>
    <label>
      cols.lg
      <input v-model.number="cols.lg" data-testid="input-cols-lg" min="1" step="1" type="number" />
    </label>
    <label>
      cols.md
      <input v-model.number="cols.md" data-testid="input-cols-md" min="1" step="1" type="number" />
    </label>
    <label>
      cols.sm
      <input v-model.number="cols.sm" data-testid="input-cols-sm" min="1" step="1" type="number" />
    </label>
  </div>

  <div class="demo-grid-wrap" :style="{ maxWidth: `${containerWidth}px` }">
    <GridLayout
      :layout="layout"
      :responsive="true"
