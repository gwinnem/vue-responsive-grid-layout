<template>
  ...
  <div class="demo-controls">
    <label>
      <input v-model="verticalCompactEnabled" data-testid="toggle-vertical-compact" type="checkbox" /> compactType (vertical vs none)
    </label>
    <div
    ...
    <button data-testid="reset-grids" type="button" @click="resetGrids">Reset</button>
  </div>

  <div class="demo-cross-grids" data-testid="external-drop-view-wrap">
    <div class="demo-grid-wrap">
      <p class="demo-grid-label">Grid 1</p>
      <GridLayout
      ...
      >
        ...
        >
          <div class="demo-item">{{ item.label ?? item.i }}</div>
        </GridItem>
      </GridLayout>
    </div>
    <div class="demo-grid-wrap">
      <p class="demo-grid-label">Grid 2</p>
      <GridLayout
