  ...
  <div class="demo-controls">
    ...
    <label>
      <input
        ...
        data-testid="toggle-horizontal-shift"
        type="checkbox" />
      Horizontal shift
    </label>
    <label>
      <input
        ...
        data-testid="toggle-distribute-evenly"
        type="checkbox" />
      Distribute evenly
    </label>
    <label>
      <input
        ...
        data-testid="toggle-restore-on-drag"
        type="checkbox" />
      Restore on drag
    </label>
    <label>
    ...
    <label>
      <input
        ...
        data-testid="toggle-css-transforms"
        type="checkbox" />
      Use CSS transforms
    </label>
    <label>
    ...
    <label>
      <input
        ...
        data-testid="toggle-use-border-radius"
        type="checkbox" />
      Use border radius
    </label>
    <label>
    ...
    <label>
      ...
      <input
        ...
        data-testid="input-transform-scale"
        max="2"
        min="0.25"
        step="0.05"
        type="number" />
