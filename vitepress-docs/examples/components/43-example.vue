<template>
  <ExampleDemo title="Undo/redo (enableUndoRedo)">
    ...
    <template #controls>
      ...
      <button data-testid="add-item-button" type="button" @click="addItem">Add item</button>
      <ExampleNumberField v-model="undoHistoryLimit" label="undoHistoryLimit" :min="1" :max="20" />
    </template>
