<template>
  <div class="sandbox-shell">
    ...
    <main class="sandbox-main">
      <div class="demo-controls-groups">
        <fieldset class="demo-controls">
          ...
          <label for="scrollFocusItemId">
            ...
            <input
              id="scrollFocusItemId"
              v-model="scrollFocusItemId"
              style="width: 60px"
              type="text" />
          </label>
          <button
            type="button"
            @click.prevent="refLayout.scrollToItem(scrollFocusItemId)">
            Scroll to item
          </button>
          <button
            type="button"
            @click.prevent="refLayout.focusItem(scrollFocusItemId)">
            Focus item
          </button>
          <button
            type="button"
            @click.prevent="refLayout.compactNow()">
            compactNow
          </button>
          <button
            type="button"
            @click.prevent="refLayout.rearrange()">
            rearrange
          </button>
          <button
            type="button"
            @click.prevent="refLayout.duplicateItem(scrollFocusItemId)">
            duplicateItem
          </button>
        </fieldset>
        ...
        <fieldset class="demo-controls">
          ...
          <label for="rowHeight">Row Height (px)<input
            id="rowHeight"
            v-model="rowHeight"
            type="number"
            @change="onRowHeightChange" /></label>
          <label for="colNum">Max Columns<input
            id="colNum"
            v-model="colNum"
            type="number"
            @change="onColNumChange" /></label>
          <label for="maxRows">Max Rows<input
            id="maxRows"
            v-model="maxRows"
            type="number"
            @change="onMaxRowsChange" /></label>
          <label for="mtb">Margin Top / Bottom<input
            id="mtb"
            v-model="marginTopBottom"
            type="number"
            @change="onMarginTopBottomChange" /></label>
          <label for="mlr">Margin Left / Right<input
            id="mlr"
            v-model="marginLeftRight"
            type="number"
            @change="onMarginLeftRightChange" /></label>
          <label for="borderRadius">Border Radius<input
            id="borderRadius"
        ...
        <fieldset class="demo-controls">
          ...
          <label for="hideLayout"><input
            id="hideLayout"
            v-model="hideLayout"
            type="checkbox" />Hide Layout</label>
          <label for="hideEventLog"><input
            id="hideEventLog"
            v-model="hideEventLog"
            type="checkbox" />Hide Event Log</label>
          <label for="hideDroppable"><input
            id="hideDroppable"
            v-model="hideDroppable"
            type="checkbox" />Hide Droppable</label>
        </fieldset>

        <fieldset class="demo-controls">
          <legend>Compaction & collision</legend>
          <label for="distributeEvenly"><input
            id="distributeEvenly"
            v-model="distributeEvenly"
            type="checkbox" />distributeEvenly</label>
          <label for="preventCollision"><input
            id="preventCollision"
            v-model="preventCollision"
            type="checkbox" />preventCollision</label>
          <label for="restoreOnDrag"><input
            id="restoreOnDrag"
            v-model="restoreOnDrag"
            type="checkbox" />restoreOnDrag</label>
          <label for="horizontalShift"><input
            id="horizontalShift"
            v-model="horizontalShift"
            type="checkbox" />horizontalShift</label>
        ...
        <fieldset class="demo-controls">
          ...
          <label for="autosize"><input
            id="autosize"
            v-model="autoResizeGridLayout"
            type="checkbox" />autosize</label>
          <label for="isBounded"><input
            id="isBounded"
            v-model="isBounded"
            type="checkbox" />isBounded</label>
          <label
            class="sandbox-hidden"
            for="isDraggable"><input
              id="isDraggable"
              v-model="isDraggable"
              type="checkbox" />isDraggable</label>
          <label
            class="sandbox-hidden"
            for="isResizable"><input
              id="isResizable"
              v-model="isResizable"
              type="checkbox" />isResizable</label>
          <label for="isMirrored"><input
            id="isMirrored"
            v-model="isMirrored"
            type="checkbox" />isMirrored</label>
          <label for="isResponsive"><input
            id="isResponsive"
            v-model="isResponsive"
            type="checkbox" />isResponsive</label>
          <label for="preserveAspectRatio"><input
            id="preserveAspectRatio"
            v-model="preserveAspectRatio"
            type="checkbox" />preserveAspectRatio</label>
          <label for="showResizeHandles"><input
            id="showResizeHandles"
            v-model="showResizeHandles"
            type="checkbox" />showResizeHandles</label>
          <label for="customResizeHandle"><input
            id="customResizeHandle"
            v-model="customResizeHandle"
            type="checkbox" />custom #resize-handle</label>
          <label for="autoScroll"><input
            id="autoScroll"
            v-model="autoScroll"
            type="checkbox" />autoScroll</label>
          <label for="useBorderRadius"><input
            id="useBorderRadius"
            v-model="useBorderRadius"
            type="checkbox" />useBorderRadius</label>
          <label for="resizeHandleColor">
            resizeHandleColor:
            <input
              id="resizeHandleColor"
        ...
        <fieldset class="demo-controls">
          ...
          <label for="showGridLines"><input
            id="showGridLines"
            v-model="showGridLines"
            type="checkbox" />showGridLines</label>
          <label for="snapToGrid"><input
            id="snapToGrid"
            v-model="snapToGrid"
            type="checkbox" />snapToGrid</label>
        ...
        <fieldset class="demo-controls">
          ...
          <label for="editMode"><input
            id="editMode"
            v-model="enableEditMode"
            type="checkbox" />editMode</label>
          <label for="layoutEnableEditMode"><input
            id="layoutEnableEditMode"
            v-model="layoutEnableEditMode"
            type="checkbox" />enableEditMode (grid-wide)</label>
          <label for="showCloseButton"><input
            id="showCloseButton"
            v-model="showCloseButton"
            type="checkbox" />showCloseButton</label>
          <label for="spanishLabels"><input
            id="spanishLabels"
            v-model="spanishLabels"
            type="checkbox" />ariaLabels (Spanish)</label>
        </fieldset>

        <fieldset class="demo-controls">
          <legend>Multi-select & auto-height</legend>
          <label for="multiSelect"><input
            id="multiSelect"
            v-model="multiSelect"
            type="checkbox" />multiSelect</label>
          <label for="autoHeight"><input
            id="autoHeight"
            v-model="autoHeight"
            type="checkbox" />autoHeight</label>
        </fieldset>

        <fieldset class="demo-controls">
          <legend>Outside drop</legend>
          <label for="allowOutsideDrop"><input
            id="allowOutsideDrop"
            v-model="allowOutsideDrop"
            type="checkbox" />allowOutsideDrop</label>
        </fieldset>
      ...
      <div
        v-if="allowOutsideDrop"
        class="demo-controls">
        <div
          class="demo-droppable"
          draggable="true"
          @dragstart="onOutsideDragStart">
        ...
        <div id="content">
          <GridLayout
            ...
            <GridItem
              ...
              <template
                v-if="customResizeHandle"
                #resize-handle="{ edge }">
                <span
                  class="sandbox-resize-icon"
                  :title="edge">⤡</span>
              </template>
            </GridItem>
          </GridLayout>
...
<script lang="ts" setup>
  ...
  const onContainerResized = (value: string | number): void => {
  ...
  const onDragMove = (i: string | number, newX: number, newY: number): void => {
    if(selected.value.includes('dragMoveEvent') || selected.value.includes('All')) {
      publishToEventLog(i, 'dragMoveEvent', newX, newY);
    }
  };

  const onDragStart = (i: string | number, newX: number, newY: number): void => {
  ...
  function setChildRef(vm: unknown): void {
    const instance = vm as { i?: string | number } | null;
    if(instance && instance.i) {
      mapCache.set(instance.i, instance);
    }
  }
